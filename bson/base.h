...
inline void uassert(unsigned a, const char *str, bool x) { assert(x); }
inline void uassert(unsigned, std::string, bool x) { assert(x); }
inline void msgasserted(unsigned x, std::string s) {
